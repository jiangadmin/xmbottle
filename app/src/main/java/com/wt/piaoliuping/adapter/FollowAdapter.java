...
public class FollowAdapter extends BaseItemAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageLoader.getInstance().displayImage(result.findAsString("toUserLocal>avatarPreView"), holder.itemImage, App.app.getImageCircleOptions());
        ...
        int type = result.findAsInt("type");
        if (type == 1) {
            holder.textTime.setText("已关注");
        } else {
            holder.textTime.setText("互相关注");
        }
        return convertView;
    }
