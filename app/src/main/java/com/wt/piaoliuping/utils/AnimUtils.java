...
public class AnimUtils {
    ...
    //头像旋转还原
    public static void R270(View v) {
    ...
    //向左
    public static void animxiangzuonum(View v, int num) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(v, "translationX", num, 0);
        AnimatorSet set = new AnimatorSet();
        set.playSequentially(animator);
        set.setDuration(200);
        set.setInterpolator(new LinearInterpolator());
    ...
    //X轴移动
    public static void X(View v, int from, int to) {
    ...
    //X轴移动
    public static void XD(View v, int from, int to) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(v, "translationX", from, to);
        AnimatorSet set = new AnimatorSet();
        set.playSequentially(animator);
        set.setDuration(500);
